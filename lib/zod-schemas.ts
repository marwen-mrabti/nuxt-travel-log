...
export const DescriptionSchema = z.string({ message: "Description is required" }).min(10, "Description is required").max(120, "Description must be less than 120 characters").refine(val => val.trim() !== "", {
