...
export const DescriptionSchema = z.string({ message: "Description is required" }).min(10, "Description must be more than 10 characters").max(500, "Description must be less than 500 characters").refine(val => val.trim() !== "", {
